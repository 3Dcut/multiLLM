...
Sub CreateSetupScript()
    ...
    File.WriteLine "$needsUpdate = ($remoteDate -ne $null) -and ($remoteDate -gt $localDate)"
    File.WriteLine ""
    ...
    File.WriteLine "    $r = [System.Windows.Forms.MessageBox]::Show($t.updateAvailable + ""`n"" + $t.updateNow, 'LLM MultiChat', 'YesNo', 'Question')"
