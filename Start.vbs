...
$localTs = Get-LocalTimestamp
    ...
    File.WriteLine "    File.WriteLine "    if (-not (Show-Disclaimer)) {"
    ...
    File.WriteLine "    }"
    File.WriteLine "    "
    Save-UpdateInfo $remote.date $remote.sha
    File.WriteLine "}"
    File.WriteLine "# Update - MODIFIED: Silently update timestamp to prevent overwriting local changes"
